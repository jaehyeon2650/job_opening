...
import static project.general_project.domain.QAssessment.*;
...
public class AssessmentRepository {
    ...
    public double getAverageScore(Long memberId) {
        Double result = (Double) em.createQuery("select avg(a.score) from Assessment a where a.toMember.id = :id", Double.class)
